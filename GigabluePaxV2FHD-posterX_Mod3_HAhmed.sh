...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/team-blue/main/GigabluePaxV2FHD-posterX_Mod3_HAhmed.tar.gz"
wait
tar -xzf GigabluePaxV2FHD-posterX_Mod3_HAhmed.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/GigabluePaxV2FHD-posterX_Mod3_HAhmed.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
